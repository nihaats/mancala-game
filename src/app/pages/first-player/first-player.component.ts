...
export class FirstPlayerComponent implements OnInit {
  ...
  // todo: 2 tane parametre geçilecek player1 = false, player2 = false
  // turn(player1: boolean = false, player2: boolean = false){
  //   if (playerNumber == 1) {
  //     this.isPlayer1 = true;
